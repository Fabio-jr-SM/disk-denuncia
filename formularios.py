...
def encaminhar_orgao_responsavel(Município,option):
    if Município.lower() in ['cuiabá','cuiaba']:
        if option in ['Vazamentos', 'Esgotos a céu aberto']:
            st.success("Sua denuncia foi encaminhada para o Orgão: Águas Cuiaba")
        elif option in ['Buracos nas vias']:
            st.success("Sua denuncia foi encaminhada para o Orgão: Infraestrutura de Cuiabá")
        elif option in ['Fiação elétrica','Falta de internet']:
            st.success("Sua denuncia foi encaminhada para o Orgão: Energisa de Cuiabá")
        elif option in ['Lixo acumulado','Poda de árvores']:
            st.success("Sua denuncia foi encaminhada para o Orgão: limpurb de Cuiabá")
        elif option in ['Outros']:
            st.success("Sua denuncia foi encaminhada para o Orgão a Analise da Prefeitura de Cuiabá")
    else:
        if option in ['Vazamentos', 'Esgotos a céu aberto']:
            st.success("Sua denuncia foi encaminhada para o Orgão: DAE De Varzéa Grande")
        elif option in ['Buracos nas vias']:
            st.success("Sua denuncia foi encaminhada para o Orgão: Infraestrutura De Varzéa Grande")
        elif option in ['Fiação elétrica','Falta de internet']:
            st.success("Sua denuncia foi encaminhada para o Orgão: Energisa De Varzéa Grande")
        elif option in ['Lixo acumulado','Poda de árvores']:
            st.success("Sua denuncia foi encaminhada para o Orgão: limpurb De Varzéa Grande")
        elif option in ['Outros']:
            st.success("Sua denuncia foi encaminhada para o Orgão a Analise da Prefeitura De Varzéa Grande")
...
def criar_formulario_denuncia():
    ...
    if button_pressed:
        ...
        if on:
            st.success('Acompanhe sua denuncia Usando o Seu ID: ',cont_pessoa+1)
        else:
